...
<body>
    <form id="form1" runat="server">
        <table width="560" align="center">
            <tr>
                <td width="100%" align="right">
                    ...
                    <br />
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/well come.aspx">Home</asp:HyperLink>
                </td>
            </tr>
        </table>     
        <br />
        <table width="560" align="center">
            <tr>
                <td>
                    <asp:Image ID="imgResults" SkinID="results" runat="server" />
                    <br />
            ...
            <tr>
                <td><a href="default.aspx">Return to Main Menu</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/well come.aspx">FINISH 
                    THE TEST</asp:HyperLink>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
